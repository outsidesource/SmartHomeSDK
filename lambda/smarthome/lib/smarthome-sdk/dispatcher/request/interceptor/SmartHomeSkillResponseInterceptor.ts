 ...
 */
export interface SmartHomeSkillResponseInterceptor extends ResponseInterceptor<HandlerInput<ResponseBuilder>, Response<ResponsePayload>> {
  /**
   ...
   */
  process(input: HandlerInput<ResponseBuilder>, response?: Response<ResponsePayload>): Promise<void> | void
}
